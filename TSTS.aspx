<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Index.Master" Async="true" AutoEventWireup="true" CodeBehind="TSTS.aspx.cs" Inherits="SDH_VICTORY.TSTS" %>
        ...
        <ContentTemplate>
            <div class="card" >
                <div class="card-header text-center card-primary-tvu card-header-tvu">
                    <h3>PHIẾU ĐĂNG KÝ TUYỂN SINH THẠC SĨ</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col text-center text-primary">
                            <h3>Thông tin văn bằng đại học thí sinh sử dụng để dự tuyển thạc sĩ</h3>
                        </div>
                    </div>
                    <div class="row">
                        <%--<div class="col-lg mt-2">
                        ...
                        <div class="col-lg mt-2">
                            ...
                            <asp:TextBox CssClass="form-control" required="true" placeholder="Chuyên ngành" ID="txt_cnganh" runat="server" />
                            <%--<asp:DropDownList runat="server" ID="dr_chuyenganh" CssClass="select">
                            </asp:DropDownList>--%>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                       <%-- <div class="col-lg mt-2">
                            <p>Phiếu dự tuyển <span class="auto-style1">*</span></p>
                            <asp:FileUpload runat="server" ID="file_phieudutuyen" required="true" accept="image/*, application/pdf"/>
                        </div>--%>
                        <div class="col-lg mt-2">
                            <p>Sơ yếu lý lịch <span class="auto-style1">*</span></p>
                            <asp:FileUpload runat="server" ID="file_soyeulilich" required="true" accept="image/*, application/pdf"/>
                        </div>
                        <div class="col-lg mt-2">
                            <p>Căn cước công dân <span class="auto-style1">*</span></p>
                    ...
                    <div class="row">
                        <div class="col-lg mt-2">
                            <p>Bằng đại học<span class="auto-style1">*</span></p>
                            <asp:FileUpload runat="server" ID="file_bangdh" required="true" accept="image/*, application/pdf"/>
                        </div>
                        <div class="col-lg mt-2">
                            <p>Bảng điểm đại học <span class="auto-style1">*</span></p>
                    ...
                    <hr />
                        <div class="row">
                            <div class="col-lg mt-2">
                                <p>Chứng chỉ ngoại ngữ <span class="auto-style1">*</span></p>
                                <asp:FileUpload runat="server" ID="file_ccnn" required="true" accept="image/*, application/pdf" />
                            </div>
                            <div class="col-lg mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg mt-2">
                            <asp:LinkButton Text="Tải trước phiếu đăng ký " CssClass="btn btn-outline-info" ID="btn_taipdf" OnClick="btn_taipdf_Click" runat="server" />
                        </div>
                    </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                <h2><asp:Label Text="Đang nộp hồ sơ..." ID="lb_progress" runat="server" /></h2>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
