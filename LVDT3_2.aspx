<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Index.Master" AutoEventWireup="true" CodeBehind="LVDT3_2.aspx.cs" Inherits="SDH_VICTORY.LVDT3_2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="text-center">
        <b><h2>Đăng ký tên đề tài, người hướng dẫn khoa học</h2></b>
        <img  style="object-fit:cover; width:100%" src="Data/img/HD/hd_1.png" />
    </div>
        ...
        <div class="card-body">
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <span>Địa chỉ</span><span class="auto-style1" style="color: #FF0000">*</span>
                            <asp:TextBox ID="Diachi" runat="server" required="true" TextMode="MultiLine" CssClass="form-control" placeholder="Địa chỉ liên hệ" />
                        </div>
                    </div>
                </div>
                    --%>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="">Người hướng dẫn (nếu có)</label>
                            <asp:TextBox ID="NHD" runat="server" CssClass="form-control" placeholder="Người hướng dẫn (nếu có) " />
                        </div>
                    </div>
                </div>
