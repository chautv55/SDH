<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Index.Master" AutoEventWireup="true" CodeBehind="DNCAPBSVB.aspx.cs" Inherits="SDH_VICTORY.DNCAPBSVB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card-body">
        <div class="container">
            <h2 class="mb-4">PHIẾU ĐỀ NGHỊ CẤP BẢNG SAO VĂN BẰNG</h2>
            <div class="row">
                <div class="col-lg">
