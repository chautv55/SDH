<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Index.Master" AutoEventWireup="true" CodeBehind="DNXNHTDT.aspx.cs" Inherits="SDH_VICTORY.DNXNHTDT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card-body">
        <div class="container">
            <h2 class="mb-4">PHIẾU ĐỀ NGHỊ XÁC NHẬN HOÀN THÀNH CHƯƠNG TRÌNH ĐÀO TẠO</h2>
            <div class="row">
                <div class="col-lg">
